...
export default function QuickAdd() {
  ...
  const handleMagicAdd = async () => {
    ...
    if (isMoney) {
      ...
      // FIX: Sesuaikan dengan format POST /api/finance
      await fetch('/api/finance', {
        ...
        body: JSON.stringify({ 
          ...
          data: { type: 'expense', amount, description: text, category: 'Auto-QuickAdd', date: new Date().toISOString() } 
        })
      });
      ...
      // FIX: Sesuaikan dengan format POST /api/brain
